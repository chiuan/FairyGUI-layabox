...
declare namespace fgui {
    class GTween {
        ...
        static to(start: number, end: number, duration: number, onTimer?: boolean): GTweener;
        static to2(start: number, start2: number, end: number, end2: number, duration: number, onTimer?: boolean): GTweener;
        static to3(start: number, start2: number, start3: number, end: number, end2: number, end3: number, duration: number, onTimer?: boolean): GTweener;
        static to4(start: number, start2: number, start3: number, start4: number, end: number, end2: number, end3: number, end4: number, duration: number, onTimer?: boolean): GTweener;
        static toColor(start: number, end: number, duration: number, onTimer?: boolean): GTweener;
        static delayedCall(delay: number, onTimer?: boolean): GTweener;
        static shake(startX: number, startY: number, amplitude: number, duration: number, onTimer?: boolean): GTweener;
...
declare namespace fgui {
    class TweenManager {
        static createTween(isOnTimer?: boolean): GTweener;
        static isTweening(target: any, propType: any): boolean;
        static killTweens(target: any, completed: boolean, propType: any): boolean;
        static getTween(target: any, propType: any): GTweener;
        static update_timer(): void;
        static update(): void;
    }
}
declare namespace fgui {
